...
#' @param n.samp Integer giving the number of records to plot the QQ relationship. Default is to use everything.
...
#' @param factor.grouping Factor grouping for visualization
